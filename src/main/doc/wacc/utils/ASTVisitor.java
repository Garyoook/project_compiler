...
public class ASTVisitor {
  ...
  public List<String> getcodes() {
    ...
    if (printOverflowError) {
      ...
      printRunTimeErr = true;
      visitStringNode(new StringNode("\t.ascii \"OverflowError: the result is too small/large to store in a 4-byte signed-integer.\\n\""));
    }
...
//    restoreReg();
  ...
  public void visitAssignAst(AssignAST ast, List<String> codes, int reg_counter) {
    if (!visitExprAST(ast.getRhs().getExpr1(), codes, reg_counter)) {
